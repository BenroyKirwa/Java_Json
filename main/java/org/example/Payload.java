...
public class Payload {
    ...
    private List<NomineeInfo> nokBeneficiaryNomineeInfo;
    ...
    public List<NomineeInfo> getNokBeneficiaryNomineeInfo() {
        return nokBeneficiaryNomineeInfo;
    }

    public void setNokBeneficiaryNomineeInfo(List<NomineeInfo> nokBeneficiaryNomineeInfo) {
